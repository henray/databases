...
/*Our warehouses must contain at least 1 unit of each product due to the CHECK constraints for our schemas */
...
BEGIN
	...
	END IF;
	IF wquantity - qty = 0 THEN -- CHECK Constraint Exception
